...
# Portage.
SRC_URI="
	amd64? ( https://download-cdn.getsyncapp.com/${PV}/linux-x64/BitTorrent-Sync_x64.tar.gz -> BitTorrentSync-Sync_x64-${PV}.tar.gz )
	x86? ( https://download-cdn.getsyncapp.com/${PV}/linux-i386/BitTorrent-Sync_i386.tar.gz -> BitTorrentSync-Sync_i386-${PV}.tar.gz )"
